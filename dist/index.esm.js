...
var CodeXmlIcon = function () { return (React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
    React.createElement("path", { d: "M15 13.3333L18.3333 10L15 6.66668M5 6.66668L1.66666 10L5 13.3333M12.0833 3.33334L7.91666 16.6667", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }))); };
var DownloadIcon = function () { return (React.createElement("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
...
var MenuItem = function (_a) {
    ...
    return (React.createElement("button", { className: "flex items-center w-full px-4 py-3 text-left hover:bg-gray-100 ".concat(isFirst ? 'rounded-t-md' : ''), onClick: onClick },
        React.createElement("span", { className: "text-gray-400 mr-3 flex items-center justify-center" }, icon),
        React.createElement("span", { className: "text-gray-400 text-[16px]" }, text)));
};
var MuralKit = function (_a) {
    ...
    var BrandmarkIcon = function () {
        ...
        return (React.createElement("span", { className: "inline-block w-5 h-5 text-gray-400", dangerouslySetInnerHTML: { __html: modifiedSvg } }));
    };
    return (React.createElement("div", { className: "relative w-full h-full", onContextMenu: handleContextMenu },
        children,
        isOpen && (React.createElement("div", { ref: menuRef, className: "fixed w-64 bg-white rounded-md shadow-lg z-10 border border-gray-100 overflow-hidden", style: {
            ...
            React.createElement(MenuItem, { icon: React.createElement(CodeXmlIcon, null), text: "Copy logo as SVG", onClick: handleCopyLogo, isFirst: true }),
            React.createElement(MenuItem, { icon: React.createElement(BrandmarkIcon, null), text: "Copy brandmark as SVG", onClick: handleCopyBrandmark }),
            React.createElement(MenuItem, { icon: React.createElement(DownloadIcon, null), text: "Download BrandKit", onClick: handleDownloadBrandkit })))));
};
